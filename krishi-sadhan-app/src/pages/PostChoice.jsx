            ...
            <div className="flex flex-col gap-6">
                ...
                >
                    ...
                    <div className="relative z-10 mt-6">
                        <h2 className="text-2xl font-black text-white">{t('rent_item')}</h2>
                        <p className="text-blue-100 text-sm mt-1 font-medium">{t('rent_desc')}</p>
                    </div>
                </button>
                ...
                >
                    ...
                    <div className="relative z-10 mt-6">
                        <h2 className="text-2xl font-black text-white">{t('sell_item')}</h2>
                        <p className="text-orange-100 text-sm mt-1 font-medium">{t('sell_desc')}</p>
                    </div>
                </button>
            </div>
        </MobileLayout>
