                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex flex-col gap-1 mb-6 text-gray-600">
                                <p className="text-lg">
                                    <span className="font-semibold text-gray-800">Price:</span> ₹{equipment.price} / {equipment.unit}
                                </p>
                                <p className="text-lg">
                                    <span className="font-semibold text-gray-800">Location:</span> {equipment.location}
                                </p>
                            </div>

                            {/* Booking Form */}
                            <div className="border-t border-gray-100 pt-6">
                                <h3 className="text-lg font-semibold mb-4 text-gray-700">Book This Equipment</h3>
